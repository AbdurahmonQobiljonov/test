...
import {
  ...
  selectModalDataByType,
} from '../../libs/slices/appSlice.ts'
...
import { Contacts } from '../../libs/models/contacts.ts'
import { updateCard } from '../../libs/slices/contacsSliice.ts'
...
export const ContactUpdateModal = () => {
  const [form] = useForm()
  const isVisible = useAppSelector(selectIsModalVisible)(ModalTypes.contactUpdate)
  const dispatch = useAppDispatch()
  const modalData = useAppSelector(selectModalDataByType)(ModalTypes.contactUpdate)
  const { data } = modalData as {
    data: Contacts
  }

  const handleClose = () => {
    dispatch(hideModal(ModalTypes.contactUpdate))
  }
